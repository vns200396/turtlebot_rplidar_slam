...
rosrun map_server map_saver -f ~/catkin_ws/src/turtle_nav/maps/$1

cp ~/catkin_ws/src/turtle_nav/maps/$1.yaml ~/catkin_ws/src/turtle_nav/maps/web_map.yaml

cp ~/catkin_ws/src/turtle_nav/maps/$1.pgm ~/catkin_ws/src/turtle_nav/maps/web_map.pgm
